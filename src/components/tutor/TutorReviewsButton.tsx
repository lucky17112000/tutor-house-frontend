        ...
        <div className="flex-1 overflow-y-auto px-6 py-5 space-y-3">
          {loading ? (
            ...
            reviews.map((r) => {
              ...
              return (
                <div key={r.id} className="rounded-2xl border border-zinc-100 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-800/60 p-4 space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between gap-2 mb-1">
                        <span className="text-[13.5px] font-semibold text-zinc-900 dark:text-white truncate">{name}</span>
                        {r.createdAt && (
