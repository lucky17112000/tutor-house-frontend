...
import StartCallButton from "@/components/booking/StartCallButton";
...
const TutorBooking = async () => {
  ...
  const bookings = Array.isArray(result)
    ? result
    : (result?.data ?? result?.bookings ?? result?.data?.bookings ?? []);

  return (
    <div className="min-h-screen bg-linear-to-br from-slate-50 to-indigo-50 dark:from-zinc-900 dark:to-zinc-800 p-6">
      <div className="max-w-6xl mx-auto">
        ...
        {bookings.length === 0 ? (
          <div className="bg-white dark:bg-zinc-800 rounded-2xl border border-gray-100 dark:border-zinc-700 p-10 text-center text-gray-500 dark:text-gray-400">
            <div className="text-4xl mb-3">📭</div>
            <p className="text-lg font-semibold">No bookings yet</p>
            <p className="text-sm mt-2">
              When students book sessions, they will appear here.
            </p>
          </div>
        ) : (
              ...
              return (
                ...
                >
                  ...
                  <div className="p-5 space-y-3">
                    ...
                    {/* বিভাজক রেখা */}
                    <div className="h-px bg-linear-to-r from-transparent via-gray-200 dark:via-zinc-600 to-transparent" />
                    ...
                    {status.toUpperCase() === "COMPLETED" && (
                      <StartCallButton bookingId={booking.id} />
                    )}
                    {status.toUpperCase() !== "COMPLETED" &&
