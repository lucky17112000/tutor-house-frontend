    ...
    <section className="th-auth-page">
      ...
      <div className="th-auth-card">
        <div className="th-auth-banner">
          ...
          <div className="th-auth-title">
            {isSignup ? "Create an account" : "My Learning Dashboard back"}
          </div>
          <div className="th-auth-sub">
            {isSignup
        ...
        <div className="th-auth-body">
          ...
          <div className="th-field">
            ...
            <div className="th-input-wrap">
              ...
              <input
                ...
                defaultValue="alex@tutorhouse.app"
              />
            </div>
          </div>
          <div className="th-field">
          ...
          <button className="th-btn th-btn-google th-btn-block">
            <svg width="16" height="16" viewBox="0 0 18 18">
              ...
              <path
                fill="#34A853"
                d="M9 18c2.43 0 4.47-.8 5.96-2.18l-2.9-2.26a5.39 5.39 0 0 1-8.06-2.83H1v2.34A9 9 0 0 0 9 18z"
              />
              <path
                fill="#FBBC05"
                d="M3.96 10.71a5.43 5.43 0 0 1 0-3.42V4.96H1a9 9 0 0 0 0 8.08l2.96-2.33z"
              />
              <path
                fill="#EA4335"
                d="M9 3.58c1.32 0 2.5.45 3.44 1.35l2.58-2.58A9 9 0 0 0 1 4.96l2.96 2.33C4.65 5.05 6.66 3.58 9 3.58z"
              />
            </svg>
